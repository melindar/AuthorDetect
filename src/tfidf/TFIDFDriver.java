...
public class TFIDFDriver extends Configured implements Tool
{
	...
	public int run(String[] args) throws Exception 
	{
		...
		FileOutputFormat.setOutputPath(job1, new Path("tfidf/" + args[1] + "1"));
		...
		FileOutputFormat.setOutputPath(job2, new Path("tfidf/" + args[1] + "2"));
		...
		FileInputFormat.addInputPath(job3, new Path("tfidf/" + args[1] + "2"));
		FileOutputFormat.setOutputPath(job3, new Path("tfidf/" + args[1] + "3"));
		...
		FileInputFormat.addInputPath(job4, new Path("tfidf/" + args[1] + "3"));
		FileOutputFormat.setOutputPath(job4, new Path("tfidf/" + args[1] + "4"));
