...
public class TFIDFDriver extends Configured implements Tool
{
	...
	public int run(String[] args) throws Exception 
	{
		...
		FileOutputFormat.setOutputPath(job1, new Path(args[1] + "/tfidf/" + "1"));
		...
		FileOutputFormat.setOutputPath(job2, new Path(args[1] + "/tfidf/" + "2"));
		...
		FileInputFormat.addInputPath(job3, new Path(args[1] + "/tfidf/" + "2"));
		FileOutputFormat.setOutputPath(job3, new Path(args[1] + "/tfidf/" + "3"));
		...
		FileInputFormat.addInputPath(job4, new Path(args[1] + "/tfidf/" + "3"));
		FileOutputFormat.setOutputPath(job4, new Path(args[1] + "/tfidf/" + "4"));
